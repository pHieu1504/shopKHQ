<!-- <?php 
$tukhoa ='Bàn Phím Cơ';
$sql_pro = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tbl_danhmuc.tendanhmuc='Bàn Phím Cơ'";
...
<div class="main1 main2">
                <div class="main1-header"> <p>Sản Phẩm Tiêu biểu: Bàn Phím cơ</p> </div>
            <div class="main1-content2  owl-carousel" >
            <?php
